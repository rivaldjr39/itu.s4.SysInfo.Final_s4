...
<div class="bareme-form-page">
    <div class="bareme-card">
        ...
        <div class="bareme-body">
            ...
            <form action="<?= site_url('admin/baremes/update/' . $bareme['id']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="field">
                    ...
                    <select id="type_operation_id" name="type_operation_id" required>
                        ...
                        <?php foreach ($types_operations as $type): ?>
                            <?php 
                            $selected = old('type_operation_id') !== null 
                                ? (old('type_operation_id') == $type['id']) 
                                : ($bareme['type_operation_id'] == $type['id']);
                            ?>
                ...
                <div class="row-fields">
                    <div class="field">
                        ...
                        <input
                            ...
                            min="0"
                            step="1"
                            value="<?= esc(old('montant_min') ?? (int)$bareme['montant_min']) ?>"
                            required
                        >
                    ...
                    <div class="field">
                        ...
                        <input
                            ...
                            min="0"
                            step="1"
                            value="<?= esc(old('montant_max') ?? (int)$bareme['montant_max']) ?>"
                            required
                        >
                ...
                <div class="row-fields">
                    <div class="field">
                        ...
                        <input
                            ...
                            min="0"
                            step="0.01"
                            value="<?= esc(old('frais_fixe') ?? $bareme['frais_fixe']) ?>"
                            required
                        >
                    ...
                    <div class="field">
                        ...
                        <input
                            ...
                            max="100"
                            step="0.01"
                            value="<?= esc(old('frais_pourcentage') ?? $bareme['frais_pourcentage']) ?>"
                            required
                        >
                ...
                <?php 
                $valDateDebut = !empty($bareme['date_debut']) ? date('Y-m-d\TH:i', strtotime($bareme['date_debut'])) : '';
                $valDateFin = !empty($bareme['date_fin']) ? date('Y-m-d\TH:i', strtotime($bareme['date_fin'])) : '';
                ?>
                ...
                <div class="row-fields">
                    <div class="field">
                        ...
                        <input
                            ...
                            id="date_debut"
                            name="date_debut"
                            value="<?= esc(old('date_debut') ?? $valDateDebut) ?>"
                        >
                    ...
                    <div class="field">
                        ...
                        <input
                            ...
                            id="date_fin"
                            name="date_fin"
                            value="<?= esc(old('date_fin') ?? $valDateFin) ?>"
                        >
                ...
                <button type="submit" class="btn-submit">Mettre à jour le barème</button>
            </form>
